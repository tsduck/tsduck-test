...
(
    # CC 1-4
    test_tsp -I craft --pid 100 --cc 1 --count 4 --payload-pattern 0123
    # CC 4, true duplicate, no AF
    test_tsp -I craft --pid 100 --cc 4 --count 1 --payload-pattern 0123
    # CC 5-6
    test_tsp -I craft --pid 100 --cc 5 --count 2 --payload-pattern 0123
    # CC 6, false duplicate, no AF
    test_tsp -I craft --pid 100 --cc 6 --count 1 --payload-pattern 4567
    # CC 7-8
    test_tsp -I craft --pid 100 --cc 7 --count 2 --payload-pattern 0123
    # CC 9, PCR
    test_tsp -I craft --pid 100 --cc 9 --count 1 --payload-pattern 0123 --pcr 123456 --private-data 1478
    # CC 9, true duplicate, distinct PCR, same AF
    test_tsp -I craft --pid 100 --cc 9 --count 1 --payload-pattern 0123 --pcr 123789 --private-data 1478
    # CC 10-12
    test_tsp -I craft --pid 100 --cc 10 --count 3 --payload-pattern 0123
    # CC 13, PCR
    test_tsp -I craft --pid 100 --cc 13 --count 1 --payload-pattern 6541 --pcr 123456 --private-data 1478
    # CC 13, true duplicate, distinct PCR, distinct AF, same payload
    test_tsp -I craft --pid 100 --cc 13 --count 1 --payload-pattern 6541 --pcr 123789 --private-data 8523
    # CC 14-0
    test_tsp -I craft --pid 100 --cc 14 --count 3 --payload-pattern 6541
